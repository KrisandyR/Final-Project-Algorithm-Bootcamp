...
struct temp_book_info { //structure yang memuat informasi buku yang sementara (dipakai di function sorting)
  char name[255];
  char writer[255];
  char isbn[255];
  char genre[255];
...
void showChoice (){
  ...
  puts("4. View All Books");
  puts("5. Update Book Informations");
  puts("6. Exit the Library");
}
